...
slider = tk.Scale(f_MFHK101, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MFBK202, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MQWK202, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MQWK203, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MFQK203_US, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MFQK203_DS, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MFAK301, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MFDK302A_US, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MFDK302A_DS, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MFDK302B, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MFAK303, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MFQK403_US, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MFQK403_DS, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MQJM501, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MQJM502, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MQJM503, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MQJM504, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MQJM701, from_=50, to=-50, resolution=0.5,
...
c.pack(side="top",anchor="e")
slider = tk.Scale(f_MQJM702, from_=50, to=-50, resolution=0.5,
